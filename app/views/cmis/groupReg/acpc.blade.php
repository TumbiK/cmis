...
<table id="dg" style="width:100%;height:50%" 
        data-options="url:'acpc_reg',fitColumns:true,singleSelect:true,rownumbers:true" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'Name_of_HH_Member'">Name ACPC Member</th>
...
<div style="margin-bottom:5px">
     ...
     TA:
        ...
        onSelect: function(rec){          
            ...
            var url3='acpcSel?id='+rec.rec_id;
      ...
      GVH
        ...
        ACPC:
        <input name="acpc" id="cc6" class="easyui-combobox" data-options="
             valueField:'acpc_number',
             textField:'acpc_name',
             onSelect: function(rec){
            $('#dg').datagrid('load',{
 ...
 Village:
    ...
    <a href="#" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="newRFO()">Add RFO </a>
      <a href="#" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="newAcpcGroup()">Add Group </a> 
...
<div id="dlgAcpc" class="easyui-dialog" style="width:360px;height:280px;padding:1px 32px" closed="true" buttons="#dlg-buttons" data-options="resizable:true,modal:true">
  <div class="ftitle">Add ACPC Details</div>
  <form id="fm" method="GET" novalidate>
    <div class="fitem">
      <label>ACPC Name:</label>
      <input name="acpc_name" id="acpc_name" class="easyui-textbox" type="text" required="true">     
    </div>
    <div class="fitem">
  ...
  <div id="dlg-buttons">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#dlgAcpc').dialog('close')" style="width:90px">Cancel</a>
</div>
    
   
<div id="dlgGroupEdit" class="easyui-dialog" style="width:840px;height:400px;padding:1px 32px" toolbar="#tb" closed="true" buttons="#dlgEdit-buttons" data-options="resizable:true,modal:true">
    <div class="ftitle">ACPC Member Registration</div>

      <table id="acpctt" style="width:780px;height:200px" pagination="false">
...
<div id="dlgEdit-buttons">
    <a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="saveAcpcBen()" style="width:90px">Add </a>
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#dlgGroupEdit').dialog('close')" style="width:90px">Cancel</a>
</div>
@stop