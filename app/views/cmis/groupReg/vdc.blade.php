...
<table id="dg" style="width:920px;height:400px" 
        data-options="url:'vdc_reg',fitColumns:true,singleSelect:true,rownumbers:true" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'Name_of_HH_Member'">Name VDC Member</th>
...
<div style="margin-bottom:5px">
     ...
     TA:
      ...
      GVH
        ...
        VDC:
        <input name="vdc" id="cc6" class="easyui-combobox" data-options="
             valueField:'vdc_number',
             textField:'vdc_name',
             onSelect: function(rec){
            $('#dg').datagrid('load',{
 ...
 Village:
    ...
    <a href="#" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="newGSFO()">Add GSFO </a>
      <a href="#" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="newVdcGroup()">Add Group </a> 
 ...
 <div id="dlgVdc" class="easyui-dialog" style="width:360px;height:280px;padding:1px 32px" closed="true" buttons="#dlg-buttons" data-options="resizable:true,modal:true">
  <div class="ftitle">Add VDC Details</div>
  <form id="fm" method="GET" novalidate>
    <div class="fitem">
      <label>VDC Name:</label>
      <input name="vdc_name" id="vdc_name" class="easyui-textbox" type="text" required="true">     
    </div>
    <div class="fitem">
  ...
  <div id="dlg-buttons">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#dlgVdc').dialog('close')" style="width:90px">Cancel</a>
</div>
   
<div id="dlgVdcEdit" class="easyui-dialog" style="width:840px;height:400px;padding:1px 32px" toolbar="#tb" closed="true" buttons="#dlgEdit-buttons" data-options="resizable:true,modal:true">
    <div class="ftitle">VDC Member Registration</div>

      <table id="vdctt" style="width:780px;height:200px" pagination="false">
...
<div id="dlgEdit-buttons">
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="saveVdcBen()" style="width:90px">Add </a>
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#dlgVdcEdit').dialog('close')" style="width:90px">Cancel</a>
</div>
