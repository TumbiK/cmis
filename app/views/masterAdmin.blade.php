...
<head>
	...
	<script type="text/javascript" src="{{asset('reportScript.js')}}"></script>
	...
	<script type="text/javascript" href="{{asset('jquery-easyui-1.4.1/datagrid-filter.js')}}"></script>
...
@yield('content')
 @if (isset($period))
	<label>Acknowledging for Period:</label><input type='text' id="period" value="{{$period}}" readonly="true"></label><input type='hidden' id="frm_id" value="{{$frm_id}}" readonly="true">
@endif
