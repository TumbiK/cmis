      ...
      ddv.datagrid({
        url:'ccflsChilddetail?hhid='+row.HH_Number+'&HH_Member_Number='+row.HH_Member_Number+'&Village='+row.Village+'&ccfls='+row.ccfls_session,
            ...
            columns:[[
                ...
                {field:'f2date',title:'2M Date Visit',width:100},
                {field:'f2MUAC',title:'2M MUAC(cm)',width:100},
                {field:'f2weight',title:'2M Weight(kg)',width:100},
                {field:'f3date',title:'3M Date Visit',width:100},
                {field:'f3MUAC',title:'3M MUAC(cm)',width:100},
                {field:'f3weight',title:'3M Weight(kg)',width:100},
                {field:'f3height',title:'3M Height(cm)',width:100},
                {field:'f6date',title:'3M Date Visit',width:100},
                {field:'f6MUAC',title:'3M MUAC(cm)',width:100},
                {field:'f6weight',title:'3M Weight(kg)',width:100},
                {field:'f6height',title:'3M Height(cm)',width:100}]],
      onResize:function(){
