...
<table id="dg" style="width:750px;height:460px"
...
<div id="toolbar">
    ...
    <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="appFFaProp()">FFA Review Proposal </a>
    

</div>

<div id="dlgFFARev" class="easyui-dialog" style="width:700px;height:480px;padding:10px 20px"
        closed="true" buttons="#dlg-buttons" modal="true">



    <div class="ftitle">FFA Proposal Technical review Information</div>
...
<hr/>
        ...
        <div class="fitem">
            ...
            <input name="ffa_review" class="easyui-textbox" required="true" data-options="multiline:true" style="height:120px;">
        </div>
    <div class="fitem">
...
<div id="dlg-buttons">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#dlgFFARev').dialog('close')" style="width:90px">Cancel</a>
</div>