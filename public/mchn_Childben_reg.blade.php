...
<table id="dg" style="width:770px;height:460px" pagination="true"
        data-options="url:'child_ben_reg',fitColumns:true,singleSelect:true,rownumbers:true,fit:true" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'caregiver'">Name of Mother/Caregiver</th>
            <th data-options="field:'mc'"editor="{type:'textbox'}">Mother/Caregiver</th>
            <th data-options="field:'cg'" editor="{type:'textbox'}">Caregiver</th>
            <th data-options="field:'Name_of_HH_Member'">Name of Child</th>
     ...
     TA:
        ...
        <input name="gvh" id="cc5" class="easyui-combobox" data-options="
         ...
         <input type="checkbox" id="checkbox1" >
                ...
                <input name="level" id="cc15" valueField="value" textField="label" data-options="data:[{label:'1',Value:'1'},{label:'2',Value:'2'},{label:'3',Value:'3'},{label:'4',Value:'4'},{label:'5',Value:'5'},{label:'6',Value:'6'}]" style="width:50px;">
      ...
      <a href="#" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="assignChildGroupFdp()">Assign Village FDP</a> 
    </div>
...
<div id="dlgChildEdit" class="easyui-dialog" style="width:840px;height:400px;padding:1px 32px" toolbar="#toolb" closed="true" buttons="#dlgEdit-buttons" data-options="resizable:true,modal:true">
    <div class="ftitle">MCHN Child Beneficiary Registration</div>

      <table id="mchnChildtt" style="width:780px;height:200px" pagination="false">
      
        
      </table>
      <div id="toolb" style="height:auto">
        <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="insertChild()">New</a>
...
<div id="dlgEdit-buttons">
    <a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="saveChildBen()" style="width:90px">Add </a>

    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#dlgChildEdit').dialog('close');$('#dg').datagrid('reload');" style="width:90px">Cancel</a>
</div>