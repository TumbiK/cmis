...
<form action='mchn_faf' method='get'>

    <div id="fitem">Form Type:
    <input name="frm_id" id="cc7" class="easyui-combobox" data-options="
        valueField:'frm_id',
        textField:'frm_type',
         data:[{frm_id:1,frm_type:'Pregnant Mothers'},{frm_id:2,frm_type:'Child Under 2'}]
        " style="width:140px;">
    </div>
     <hr>
      <div id="fitem">
     ...
     TA:
        ...
        FDP:
        <input name="FDP" id="cc6" class="easyui-combobox" data-options="
             valueField:'FDP_ID',
             textField:'FDP_name'" style="width:80px;">
        </div>
        <div id="fitem">

           <hr>
        Date of Distribution:
        <input name="DateDistribution" id="cc8" class="easyui-datebox" data-options="
             valueField:'FDP_ID',
             textField:'FDP_name'" style="width:120px;">
