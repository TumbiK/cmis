...
<form action='mchn_verification' method='get'>
    ...
    <input name="frm_id" id="cc7" class="easyui-combobox" data-options="
     ...
     TA:
        ...
        Village:
        <input name="village" id="cc6" class="easyui-combobox" data-options="
             valueField:'rec_id',
             textField:'village_name'" style="width:80px;">
         Percentage
         <input name="percentage" id="percentage" class="easyui-numberbox" style="width:80px;">%
